...
namespace DXFLibrary
{
    public class Header
    {
        ...
        [Header("$EXTMAX")]
        public Point DrawingExtendsUpperRight { get; set; }

        [Header("$EXTMIN")]
        public Point DrawingExtendsLowerRight { get; set; }
        ...
        [Header("$INSBASE")]
        public Point InsertionBase { get; set; }

        [Header("$LIMCHECK")]
        public int? CheckLimitsIfNonZero { get; set; }

        [Header("$LIMMAX")]
        public Point LimitsUpperRight { get; set; }

        [Header("$LIMMIN")]
        public Point LimitsLowerLeft { get; set; }
        ...
        [Header("$PEXTMAX")]
        public Point PaperExtensionUpperRight { get; set; }

        [Header("$PEXTMIN")]
        public Point PaperExtensionLowerLeft { get; set; }
        ...
        [Header("$PINSBASE")]
        public Point PaperSpaceInsertionBase { get; set; }

        [Header("$PLIMCHECK")]
        public int? PaperSpaceLimitCheckingIfNonZero { get; set; }

        [Header("$PLIMMAX")]
        public Point PaperSpaceUpperRightLimit { get; set; }

        [Header("$PLIMMIN")]
        public Point PaperSpaceLowerLeftLimit { get; set; }
        ...
        [Header("$PUCSORG")]
        public Point PaperSpaceUCSOrigin { get; set; }

        [Header("$PUCSXDIR")]
        public Point PaperSpaceUCSXAxis { get; set; }

        [Header("$PUCSYDIR")]
        public Point PaperSpaceUCSYAxis { get; set; }
        ...
        [Header("$UCSORG")]
        public Point UCSOrigin { get; set; }

        [Header("$UCSXDIR")]
        public Point UCSXAxis { get; set; }

        [Header("$UCSYDIR")]
        public Point UCSYAxis { get; set; }

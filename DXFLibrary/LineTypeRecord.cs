...
{
    public class LineTypeRecord : Record
    {
    ...
    {
        private LineTypeRecord _record;
        private LineTypeRecord.LineTypeElement _subrecord;
        ...
        public override void ParseGroupCode(Document doc, int groupcode, string value)
        {
            ...
            switch (groupcode)
            {
                ...
                case 40:
                    ...
                    break;
                case 49:
                    _subrecord = new LineTypeRecord.LineTypeElement();
                    _record.Elements.Add(_subrecord);
                    _subrecord.Length = double.Parse(value);
                    break;
                case 74:
                    _subrecord.Flags = (LineTypeRecord.ElementFlags)Enum.Parse(typeof(LineTypeRecord.ElementFlags), value);
                    break;
                case 75:
